...
const RESEARCH_ITEMS = {
  'civil.industrie': [
    { id: 'sorting_unlock',     label: 'Usine de traitement', cost: 300,  resources: { stone_r: 10 } },
    { id: 'crusher_unlock',     label: 'Concasseur',          cost: 500,  resources: { stone_r: 20 } },
    { id: 'refinery_unlock',    label: 'Raffinerie',          cost: 800,  resources: { iron_r: 30 } },
    { id: 'water_plant_unlock', label: "Usine d'eau",         cost: 600,  resources: { stone_r: 15 } },
