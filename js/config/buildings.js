...
const ROAD_LEVELS = [
  ...
  { level: 1,  name: 'Terre damée',          cost: 20,  resources: null,                          speedMult: 1.15, color: '#7A5E12', dashColor: 'rgba(255,255,255,0)' },
  { level: 5,  name: 'Gravier',              cost: 50,  resources: { stone: 2 },                  speedMult: 1.35, color: '#9E8C6A', dashColor: 'rgba(255,255,255,0)' },
